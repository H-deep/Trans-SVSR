...
class TestsetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        LR0 = Image.open(dir + '/' + self.frame_list[idx] +'/'+ str(2) +'/'+ 'lr0.png')
        LR1 = Image.open(dir + '/' + self.frame_list[idx] +'/'+ str(3) +'/'+ 'lr0.png')
        LR2 = Image.open(dir + '/' + self.frame_list[idx] +'/'+ str(4) +'/'+ 'lr0.png')
        hr = Image.open(dir2 + '/' + self.frame_list[idx] +'/'+ 'hr0.png')
        W, H = LR1.size
