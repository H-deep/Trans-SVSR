...
class _NetG_SAM(nn.Module):
    def __init__(self, n_intervals, n_blocks=16, inchannels=3, nfeats=64, outchannels=3, scale=2):
...
if __name__ == '__main__':
    ...
    net = _NetG_SAM(n_intervals=[6, 11], n_blocks=16, inchannels=3, nfeats=64, outchannels=3).cuda()
